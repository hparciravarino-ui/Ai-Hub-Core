...
import { AppError, ErrorSeverity } from "../../core/errors/ErrorHandler";
...
export class ChatService {
  ...
  public async initialize(dbLayer?: DatabaseLayer): Promise<void> {
    ...
    if (dbLayer) {
      ...
      // Fallback: If not passed, we can instantiate or throw.
      // But we will inject it in CoreEngine
  ...
  public updateChat(id: string, updates: Partial<ChatSession>): ChatSession {
    ...
    try {
      ...
      // For simplicity, delete and reinsert all messages
      // A more robust approach would compute the diff
